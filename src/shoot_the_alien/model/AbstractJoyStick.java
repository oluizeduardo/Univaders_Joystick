...
public abstract class AbstractJoyStick implements Runnable {
	...
	// public abstract boolean checkButtonPressed(Identifier idBtn);

//	public abstract boolean checkPOVPressed(float componentPOV);
	...
	public static AbstractJoyStick getInstance() {
		if (joystick == null) {
			// TODO: check something to instantiate the right object
