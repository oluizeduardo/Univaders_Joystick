...
public class WinnerDAO {
	...
	public boolean insertNew(Winner newWinner) {
		...
		String sql = "INSERT INTO " + TABLE_NAME + " (score, name, identification, date) " + "VALUES ("
				+ newWinner.getFinalScore() + ", " + "'" + newWinner.getName() + "', " + "'"
	...
	public ArrayList<Winner> getAllWinners() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro ao consultar lista de vencedores!", "Erro",
		...
		try {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Houve um erro de conexão com o Banco de Dados!",
						"Univaders - Erro", JOptionPane.ERROR_MESSAGE);
