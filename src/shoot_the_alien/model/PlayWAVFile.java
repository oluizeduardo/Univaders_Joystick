...
public class PlayWAVFile implements Runnable {
	...
	// When is developing the game, use this type of address:
	public static final String INTRO_WARRIOR = "resources/audio/intro_warrior.wav";
	public static final String SHOOT_LASER = "resources/audio/shoot_laser.wav";
	public static final String GAME_OVER = "resources/audio/game_over.wav";
	public static final String CLICK = "resources/audio/click.wav";
	public static final String WINNER = "resources/audio/winner.wav";
